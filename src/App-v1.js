...
function App() {
  ...
  return (
    ...
    // generally we use context per domain
    // such as one context for post and another for query etc...
...
function Archive() {
  ...
  // We're only using state to store these posts because the
  // callback function passed into useState (which generates the posts)
